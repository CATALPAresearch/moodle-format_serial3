...
export const widgetRegistry = {
  ProgressChartAdaptive: {
    ...
    dependencies: {
      ...
      description: 'Uses overview store for activities, recommendations store for feedback, taskList for adding items'
    },
  ...
  IndicatorDisplay: {
    ...
    dependencies: {
      ...
      description: 'Uses root store for learner goal, learnermodel for understanding data'
    },
  ...
  TaskList: {
    ...
    dependencies: {
      ...
      description: 'Self-contained widget, but actions are called from other widgets'
    },
  ...
  LearningStrategies: {
    ...
    dependencies: {
      ...
      sharedState: ['courseid', 'userid'],
      hasRouter: true,
      description: 'Has own router for strategy navigation (#/strategies/:strategy)'
    },
